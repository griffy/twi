...
class SnippetsControllerTest < ActionController::TestCase
  ...
  test "should create snippet" do
    assert_difference('Snippet.count') do
      post :create, snippet: { content: @snippet.content, title: @snippet.title, visibility: @snippet.visibility }
    end
  ...
  test "should update snippet" do
    put :update, id: @snippet, snippet: { content: @snippet.content, title: @snippet.title, visibility: @snippet.visibility }
    assert_redirected_to snippet_path(assigns(:snippet))
  end
